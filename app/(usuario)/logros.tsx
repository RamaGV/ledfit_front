...
export default function Logros() {
      ...
      >
        ...
        <View className="flex-1">
          ...
          {logro.obtenido ? (
            ...
            >
              <Text
                style={{ color: accentColor, fontSize: 12, fontWeight: "600" }}
              >
                Completado
              </Text>
            </View>
            ...
            >
              <Text style={{ color: textMuted, fontSize: 12 }}>Pendiente</Text>
            </View>
          )}
        </View>
      </Animated.View>
  ...
  const porcentajeTotal =
    totalLogros > 0 ? (totalObtenidos / totalLogros) * 100 : 0;
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "baseline" }}>
                ...
                <Text style={{ color: textSecondary }}>de {totalLogros}</Text>
              </View>
            </View>
