      ...
      <ScrollView className="flex-1 px-4 pt-4">
        ...
        <View className="bg-[#1E1E1E] rounded-2xl p-5 mb-6">
          ...
          <View className="flex-row justify-between mb-4">
            <View className="items-center">
              ...
              <Text className="text-white font-bold">{user?.caloriasQuemadas?.toLocaleString() || 0}</Text>
            ...
            <View className="items-center">
              ...
              <Text className="text-white font-bold">{formatTiempo(user?.tiempoEntrenado || 0)}</Text>
            ...
            <View className="items-center">
              ...
              <Text className="text-white font-bold">{user?.entrenamientosCompletos || 0}</Text>
          ...
          <View className="mt-4">
            <View className="flex-row justify-between mb-2">
              <Text className="text-white font-semibold">Progreso de logros</Text>
        ...
        <View className="bg-[#1E1E1E] rounded-2xl p-5 mb-6">
          ...
          <Text className="text-gray-300 leading-5 mb-4">
            Ledfit es tu asistente personal de entrenamiento, diseñado para ayudarte a alcanzar tus metas fitness con entrenamientos personalizados, seguimiento de progreso y un sistema de logros para mantenerte motivado.
          </Text>
          ...
          <View className="bg-[#6842FF20] p-4 rounded-xl">
            ...
            <Text className="text-gray-300 leading-5">
              El ejercicio regular no solo mejora tu condición física, sino también tu salud mental, reduciendo el estrés y mejorando la calidad del sueño.
            </Text>
          </View>
        </View>
        ...
        <View className="items-center mb-10">
          ...
          <Text className="text-gray-500 text-xs mt-1">Desarrollado con ❤️ para ayudarte a mejorar</Text>
        </View>
      </ScrollView>
    </View>
  );
...
function FuncionalidadItem({ 
  ...
  return (
    <View className={`flex-row mb-4 ${ultimoItem ? '' : 'border-b border-[#ffffff10] pb-4'}`}>
