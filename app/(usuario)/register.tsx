...
const RegisterScreen = () => {
  ...
  useEffect(() => {
    ...
    console.log('- URL completa:', `${Constants.expoConfig?.scheme}://oauth-callback`);
  ...
  const handleFacebookLogin = useCallback(async () => {
    try {
      ...
      console.log('================================================');
      console.log('Iniciando autenticación con Facebook... DEPURACIÓN MEJORADA');
      console.log('URL de redirección configurada:', redirectUrl);
        ...
        if (token && userId) {
          ...
          try {
            ...
            if (response.ok) {
              ...
              console.error('Error en respuesta de Clerk API:', errorData);
              throw new Error(`No se pudieron obtener datos del usuario de Clerk: ${response.status}`);
            }
          } catch (apiError) {
            console.error('Error al llamar API de Clerk:', apiError);
            throw apiError;
          ...
          console.error('No se obtuvo token o userId', { token: !!token, userId });
