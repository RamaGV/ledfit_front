...
export default function EditarPerfilScreen() {
  ...
  const [imagenPerfil, setImagenPerfil] = useState("https://randomuser.me/api/portraits/women/32.jpg");
  ...
  const validatePasswordFields = () => {
    ...
    if (!currentPassword) {
      setErrors(prev => ({ ...prev, currentPassword: "Ingresa tu contraseña actual" }));
      isValid = false;
    } else {
    ...
    if (newPassword && newPassword.length < 6) {
      setErrors(prev => ({ ...prev, newPassword: "La contraseña debe tener al menos 6 caracteres" }));
      isValid = false;
    } else {
  ...
  const handleSaveInfo = async () => {
    ...
    try {
      ...
      Alert.alert("Error", error.message || "No se pudo actualizar tu perfil. Intenta nuevamente.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      Alert.alert("Error", error.message || "No se pudo actualizar tu contraseña. Verifica tus datos e intenta nuevamente.");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    >
      ...
      <ScrollView className="flex-1 px-4 pt-4">
        ...
        <View className="flex-row mb-6 bg-[#1E1E1E] rounded-full p-1">
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: 10,
              borderRadius: 50,
              backgroundColor: activeSection === "info" ? "#6842FF" : "transparent",
            }}
          >
            <Text 
              style={{ 
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: 10,
              borderRadius: 50,
              backgroundColor: activeSection === "password" ? "#6842FF" : "transparent",
            }}
          >
            <Text 
              style={{ 
        ...
        {activeSection === "password" && (
          <View>
            <View className="mb-4">
              <Text className="text-white mb-2 font-medium">Contraseña actual</Text>
              <View className="bg-[#1E1E1E] rounded-lg flex-row items-center px-4 border border-[#333333]">
                <Ionicons name="lock-closed-outline" size={20} color="#6842FF" />
                <TextInput
            ...
            <View className="mb-4">
              <Text className="text-white mb-2 font-medium">Nueva contraseña</Text>
              <View className="bg-[#1E1E1E] rounded-lg flex-row items-center px-4 border border-[#333333]">
                <Ionicons name="lock-closed-outline" size={20} color="#6842FF" />
                <TextInput
                  value={newPassword}
            ...
            <View className="mb-4">
              <Text className="text-white mb-2 font-medium">Confirmar contraseña</Text>
              <View className="bg-[#1E1E1E] rounded-lg flex-row items-center px-4 border border-[#333333]">
                <Ionicons name="lock-closed-outline" size={20} color="#6842FF" />
                <TextInput
